...
declare namespace gameLib {
	...
	export declare class BaseSkeletonWindow<T extends BaseGameData = BaseGameData> extends SkeletonWindow {
	    /**
	...
	export declare class BaseSlotView<T extends BaseSlotGameData = BaseSlotGameData> extends BaseView {
	    ...
	    /** 获取单个滚动列表 */
	    getList(value: number): fgui.GList;
	    /** 所有的项变暗 */
	...
	export declare class BaseWindow<T extends BaseGameData = BaseGameData> extends EWindow {
	    /**
	 ...
	 * @author boge
	 */
	export declare class GameModel<T extends IGameData = BaseGameData> extends EProxy implements IGameModel {
	    /**
	     * @deprecated
	     */
	...
	export abstract class SlotModel<T extends BaseSlotGameData = BaseSlotGameData> extends GameModel<T> {
	    ...
	    /** 获取列表数组 */
	    getRollLists(): fgui.GList[];
	    /** 获取指定位置的列表 */
	    getRollList(index: any): fgui.GList;
	    /**
	     * 播放开奖
	     */
	...
	export class CopyObject {
	     ...
	     */
	    static copyLoader(loader: fgui.GLoader, parent?: fgui.GComponent): fgui.GLoader;
	    /**
	     * 复制一个 GTextField 对象
	     * @param textField 被复制的对象
	     * @param parent 设置一个父对象  更换的时候 会同事转换原坐标到新的父对象上
	     */
	    static copyTextField(textField: fgui.GTextField, parent?: fgui.GComponent): fgui.GTextField;
	}
