declare namespace coreLib {
    ...
    const Proxys_base: Constructor<StringBlock & ActionEvent>;
    ...
    const BaseSkeleton_base: Constructor<ActionEvent & fairygui.GComponent & BezierCurves>;
    ...
    const GoldLoader_base: Constructor<BezierCurves & fairygui.GLoader>;
    /**
     * 具有贝塞尔曲线运动的loader
     */
    ...
    export class AppRecordManager {
        ...
        static pushHistory(title: any, url: any): void;
    }
    /**
     * 资源管理类
     */
...
declare type ISkeletonData = {
     ...
     */
    classType?: { new(): coreLib.GSkeleton | coreLib.GSpineSkeleton }
}
